 ...
 */
@Component
public class BaiDuEntertainmentCrawler extends BaseCrawler {
    ...
    private final String URL = "https://feed.baidu.com/feed/data/tab/getattentionlist?" +
            "sid=114551_122154_106197_124234_120187_123018_118888_118868_118855_118832_1187" +
            "88_107317_117335_117432_124603_122791_124752_124626_123985_124559_124109_114819" +
            "_124610_124525_124771_123980_124030_110085_123289&ssid=eddd436865" +
            "7269736853696e6365c437&from=0&pu=sz%25401320_2001%252Cta%2540iphone_1" +
            "_11.0_3_604&ms=1&channel_id=3&source=wise_feed_attentiontab&di" +
            "rection=main&async=0&startlistnum=1&_=1532067902387&callback=jsonp3";
    ...
    public BaseSpider createCrawler() {
        ...
        for (int i = 0; i < requestSize; i++) {
            ...
            String url = String.format("%s&qid=", URL, System.currentTimeMillis() / 1000 - randomNumber);
    ...
    public void process(Page page) {
        ...
        if (REQUEST_URLS.contains(requestUrl)) {
            ...
            String htmlData = String.valueOf(resultTabJsonObject.get("tabTpl"));
...
//                     handleVideo(page, newsItemNode);
    ...
    private void handleContentTypeImageText(Page page,
        ...
        NewsDO newsDO = newsCoreManager.buildNewsDO(newsId, dataKey, title, 0,
                "", "", newsSource, pageTowUrl, NewsDO.NEWS_TYPE_ENTERTAINMENT,
