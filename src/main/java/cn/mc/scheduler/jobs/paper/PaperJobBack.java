...
//
//import cn.mc.core.dataObject.paper.GrabPaperLogDO;
...
//
//@Component
//public class PaperJobBack extends BaseJob {
//
//    @Autowired
...
//                String domain = paperDo.getDomain();
//
//                /**
//                 * 验证链接报纸网站是否正常
//                 */
//                String[] results = HttpUtils.sendGets(domain, "", paperDo.getEncoding());
...
//                resJson = HttpUtils.sendGet(domainUrl, "", paperDO.getEncoding());
//            }
//
...
//        boolean resultFlag = true;
//        try {
//            String resJson = HttpUtils.sendGet(pageUrl, "", paperDO.getEncoding());
//
//            /**
//             * 验证请求版面url是否正常
//             */
...
//        boolean resultFlag = true;
//        try {
//            String resJson = HttpUtils.sendGet(titleUrl, "", paperDO.getEncoding());
//
//            /**
//             * 验证标题地址是否正常
//             */
...
//        paperNewsDO.setDataUrl(dataUrl);
...
//     * @param status
//     */
//    private void updatePaperByGrapStatus(Long paperId, Integer status, GrabPaperLogDO grabPaperLogDO) {
