 ...
 */
@Component
public class YahooSportGolfCrawler extends BaseCrawler {

    private static final Logger LOG = LoggerFactory.getLogger(YahooSportHomeCrawler.class);
    private static final String URL = "https://sports.yahoo.com/golf/";
    ...
    private void crawlerList(Page page) {
        LOG.info("抓取 Yahoo 高尔夫球新闻 begin!");
        ...
        for (Selectable node : nodes) {
            ...
            String newsSource = NewsDO.DATA_SOURCE_YAHOO_SPORT_GOLF;
