...
@Component
@Deprecated
public class EntertainmentCrawler2 extends BaseCrawler {

    private Site site = Site.me().setRetryTimes(3).setSleepTime(200);

    private static final String URL = "https://m.toutiao.com/list/?i=1&tag=news_entertainment&ac=wap" +
            "&max_behot_time=%s&i=%s&count=20" +
            "&format=json_raw&as=A1F5AB346CD02CA" +
            "&cp=5B4CD0C20C0A8E1&_signature=B0ZziwAAXA-4MIJt7fqazgdGc5";
    ...
    public Spider createCrawler() {
        ...
        for (int i = 0; i < requestSize; i++) {
            ...
            long minBeHostTime = System.currentTimeMillis() / 1000 - 10000 * i;
            long currentTime = System.currentTimeMillis();
            String url = String.format(URL, minBeHostTime, currentTime);
