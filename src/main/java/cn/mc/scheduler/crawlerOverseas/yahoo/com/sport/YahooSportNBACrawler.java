 ...
 */
@Component
public class YahooSportNBACrawler extends BaseCrawler {

    private static final Logger LOG = LoggerFactory.getLogger(YahooSportHomeCrawler.class);
    private static final String URL = "https://sports.yahoo.com/nba/";
    ...
    private void crawlerList(Page page) {
        ...
        for (Selectable node : nodes) {
            ...
            String newsSource = NewsDO.DATA_SOURCE_YAHOO_SPORT_NBA;
